...
from cappo_backend.models.capability_mount import CanonicalEffectRequest, AdapterBinding
...
'''
Path('cappo_backend/capability_mount/effects.py').write_text(content, encoding='utf-8')
print("Patched effects successfully.")
