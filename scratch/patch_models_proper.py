...
content = Path('cappo_backend/models/capability_mount.py').read_text(encoding='utf-8')
...
if "class CanonicalEffectRequest" not in content:
    ...
    Path('cappo_backend/models/capability_mount.py').write_text(content, encoding='utf-8')
