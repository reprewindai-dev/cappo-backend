...
**Claim ID:** `VEKLOM-CLAIM-WID-4-001`  
...
> P5 truth transitions are locally verified to require identity-bound `truth.transition` authority for the attached source commit and artifact set.
...
`WID-5: PGL refuses evidence without identity chain`
